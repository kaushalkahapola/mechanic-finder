...
export const mechanicsData: Mechanic[] = [
  {
    ...
    reviewCount: 124,
    distance: 1.2,
    services: ['Engine Repair', 'Transmission', 'Brakes', 'Electrical', 'Fuel Delivery', 'Flat Tyre Assistance'],
  ...
  },
  {
    ...
    reviewCount: 98,
    distance: 2.5,
    services: ['Oil Change', 'Tune-up', 'AC Repair', 'Diagnostics', 'Battery Jump-Start', 'Fuel Delivery'],
  ...
  },
  {
    ...
    reviewCount: 156,
    distance: 3.1,
    services: ['Engine Overhaul', 'Suspension', 'Steering', 'Exhaust', 'Flat Tyre Assistance', 'Battery Replacement'],
